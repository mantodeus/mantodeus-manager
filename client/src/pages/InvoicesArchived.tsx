...
import { FileText, ArrowLeft, Loader2, Search, SlidersHorizontal, X, CheckCircle2, Archive, Trash2 } from "@/components/ui/Icon";
...
export default function InvoicesArchived() {
  ...
  const filteredInvoices = useMemo(() => filterInvoices(archivedInvoices), [archivedInvoices, searchQuery, filters, contacts]);
                      ...
                      .map((invoice) => {
                        ...
                        return (
                          <Card
                            ...
                            onClick={() => {
                              handlePreviewPDF(invoice.id, `${displayName}.pdf`);
                              setIsSearchOpen(false);
                            }}
                          >
      ...
      {filteredInvoices.length === 0 ? (
        <Card className="p-8 text-center">
          <p className="text-muted-foreground">
            {hasActiveFilters
              ? "No archived invoices found matching your filters"
