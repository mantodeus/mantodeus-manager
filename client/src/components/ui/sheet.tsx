    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          "bg-card fixed z-50 flex flex-col shadow-xl border-border/50",
          // Animation base
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
        ...
        {...props}
      >
        {/* Safe area spacer - ensures content starts below iOS status bar */}
        {/* This is a dedicated element so it can't be overridden by className props like p-0 */}
