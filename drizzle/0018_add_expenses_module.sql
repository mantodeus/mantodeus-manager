...
CREATE INDEX IF NOT EXISTS `expenses_createdBy_status_expenseDate_idx` ON `expenses` (`createdBy`, `status`, `expenseDate`);
CREATE INDEX IF NOT EXISTS `expenses_createdBy_expenseDate_idx` ON `expenses` (`createdBy`, `expenseDate`);
CREATE INDEX IF NOT EXISTS `expenses_updatedByUserId_idx` ON `expenses` (`updatedByUserId`);
...
CREATE INDEX IF NOT EXISTS `expense_files_expenseId_idx` ON `expense_files` (`expenseId`);
