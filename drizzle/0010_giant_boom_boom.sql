...
ALTER TABLE `company_settings` ADD `streetName` varchar(255);--> statement-breakpoint
ALTER TABLE `company_settings` ADD `streetNumber` varchar(50);--> statement-breakpoint
ALTER TABLE `company_settings` ADD `postalCode` varchar(20);--> statement-breakpoint
ALTER TABLE `company_settings` ADD `city` varchar(120);--> statement-breakpoint
ALTER TABLE `company_settings` ADD `country` varchar(120);--> statement-breakpoint
ALTER TABLE `company_settings` ADD `invoiceNumberFormat` varchar(50);--> statement-breakpoint
