...
export const contacts = mysqlTable("contacts", {
  ...
  type: mysqlEnum("type", ["business", "private"]).default("business").notNull(),
  ...
  vatStatus: mysqlEnum("vatStatus", ["subject_to_vat", "not_subject_to_vat"]).default("not_subject_to_vat").notNull(),
  vatNumber: varchar("vatNumber", { length: 50 }),
  taxNumber: varchar("taxNumber", { length: 50 }),
  leitwegId: varchar("leitwegId", { length: 50 }),
